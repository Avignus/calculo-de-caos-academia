...
class Academia:
    ...
    def pegar_halter(self, peso):
        posicao_halter = list(self.porta_halteres.values()).index(peso)
        key_halter = list(self.porta_halteres.keys())[posicao_halter]
...
class Usuario:
    ...
    def iniciar_treino(self):
        ...
        self.peso = random.choice(espacos)
    ...
    def finalizar_treino(self):
        ...
        if self.tipo == 1:
            if self.peso in espacos:
                ...
                posicao_aleatoria = random.choice(espacos)
                self.academia.devolver_halter(posicao_aleatoria, self.peso)
        if self.tipo == 2:
            posicao_aleatoria = random.choice(espacos)
            self.academia.devolver_halter(posicao_aleatoria, self.peso)
        self.peso = 0
